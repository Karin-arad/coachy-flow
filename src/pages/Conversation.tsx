  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-white overflow-hidden p-6">
      ...
      >
        ...
        <h1 className="text-2xl font-bold mb-4 text-center">Conversation Screen</h1>
        
        <div className="bg-mint-50 rounded-xl p-6 shadow-sm border border-mint-100">
          <p className="text-center mb-6">
            Welcome to Koachi! This is where we'll have our conversation to help you find the perfect workout for today.
          </p>
